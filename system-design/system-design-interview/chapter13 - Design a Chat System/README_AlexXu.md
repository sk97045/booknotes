...
![store-relay-message](images/alex/store-relay-message.png)
...
![web-sockets](images/alex/web-sockets.png)
...
![refined-high-level-design](images/alex/refined-high-level-design.png)
...
![one-on-one-chat-table](images/alex/one-on-one-chat-table.png)
...
![group-chat-table](images/alex/group-chat-table.png)
...
![service-discovery](images/alex/service-discovery.png)
...
### 1 on 1 chat flow
![one-on-one-chat-flow](images/alex/one-on-one-chat-flow.png)
...
![message-sync](images/alex/message-sync.png)
...
![group-chat-flow](images/alex/group-chat-flow.png)
...
![recipient-group-chat](images/alex/recipient-group-chat.png)
...
![user-login-online](images/alex/user-login-online.png)
...
![user-logout-offline](images/alex/user-logout-offline.png)
...
![user-heartbeat](images/alex/user-heartbeat.png)
...
![presence-status-fanout](images/alex/presence-status-fanout.png)
...
![whatsapp-chat-jordan](images/alex/WhatsappChat.png)
